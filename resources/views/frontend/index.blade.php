...
<!-- <img src="front/assets/img/logo.webp" alt=""> -->
			...
			<div class="col-lg-7 content-col" data-aos="fade-up">
				<div class="content">
					...
					<div class="description">
						<p>Dapatkan penghasilan tak terbatas melalui sistem MLM Binary yang adil dan transparan.
							Bonus pairing hingga Rp16.000.000 per level, dukungan penuh dari tim, dan produk berkualitas tinggi.
						Gabung sekarang — karena sukses tidak perlu ditunda!</p>
					</div>
	...
	<div class="row gx-5 align-items-center">
		...
		<div class="col-lg-6 mt-4 mt-lg-0" data-aos="fade-left" data-aos-delay="300">
			<div class="about-content">
				...
				<p class="lead">Membangun jaringan bisnis yang kuat, profesional, dan berintegritas melalui sistem kemitraan dan edukasi yang transparan.

					Memberikan peluang usaha kepada masyarakat luas dengan modal terjangkau dan sistem bonus yang adil.

					Meningkatkan kesejahteraan para mitra melalui produk berkualitas dan dukungan pelatihan yang berkelanjutan.

					Menjadi wadah pertumbuhan bersama (Tumbuh Bersama) di mana setiap individu memiliki kesempatan yang sama untuk sukses.

				Mengembangkan inovasi digital dan teknologi sistem binary untuk mempercepat dan mempermudah pencapaian mitra di seluruh Indonesia.</p>
...
@else
    <script>console.error("❌ orderId tidak ditemukan");</script>
@endif
<!-- Contact Section -->
    ...
    <div class="row g-3">
            ...
            <div class="form-group">
                ...
                <div class="d-flex flex-column flex-md-row gap-3">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label text-white" for="method_qris">Pembayaran via QRIS</label>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12" id="rekening-info" style="display: none;">
            ...
            <div class="form-group">
                ...
                <div class="drop-zone" onclick="document.getElementById('payment_proof').click()">
                    <span class="drop-zone-text" id="drop-zone-label">Klik atau drag file ke sini</span>
                    <input type="file" name="payment_proof" id="payment_proof" class="drop-zone-input" hidden required accept="image/*,application/pdf">
                </div>
            </div>
        </div>
        </div>
        ...
        {{-- QRIS --}}
        <div class="col-12 text-center" id="qris-info" style="display: none;">
...
Designed by <a href="#">Art Media</a>
</div>
</div>
</footer>
<!-- Scroll Top -->
    ...
    form.addEventListener('submit', function (e) {
        ...
        .then(data => {
            ...
            if (data.redirect) {
                ...
                console.log("✅ Parsed qrUrl:", qrUrl);
            ...
            .then(data => {
                if (data.status === 'paid') {
                    ...
                    toastr.success("✅ Pembayaran berhasil!");
                     // ✅ Reset form
					    form.reset();
					    document.getElementById('drop-zone-label').textContent = 'Klik atau drag file ke sini';
                    ...
                    // ✅ Tambahkan info atau redirect jika perlu
                    document.getElementById('form-result').innerHTML = "✅ Pendaftaran berhasil. Silakan cek email Anda.";

                    // Optional: redirect ke halaman sukses
                    // window.location.href = '/sukses-pendaftaran';
                } else {
