...
Route::put('/pre-registrations/{id}/approve', [PreRegistrationController::class, 'approve'])->name('pre_registrations.approve');
Route::get('/pre-registration/qris', [PreRegistrationController::class, 'showQris'])->name('preregistration.qris');
Route::post('/pre-registrations/{id}/approve', [\App\Http\Controllers\Admin\PreRegistrationApprovalController::class, 'approve'])->name('admin.pre-registrations.approve');
