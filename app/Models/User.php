...
public function getRightChild()
{
    ...
    protected $fillable = [
        'name', 'username', 'email', 'password', 'sponsor_id', 'upline_id',
        'position', 'level', 'is_active', 'joined_at', 'tax_id', 'address',
        'bank_account', 'kiri_count', 'kanan_count', 'pairing_count', 'pairing_child_count','ro_purchase_count'
    ];
